...
#ifndef CPPMINECRAFT_ITEM_H
#define CPPMINECRAFT_ITEM_H
...
namespace Entity {
    ...
    public:
        static int is_plant(int w);

        static int is_obstacle(int w);

        static int is_transparent(int w);

        static int is_destructable(int w);
    };
}


#endif //CPPMINECRAFT_ITEM_H
