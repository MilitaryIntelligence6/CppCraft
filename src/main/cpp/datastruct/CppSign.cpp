...
void DataStruct::CppSign::_sign_list_add(SignList *list, Sign *sign) {
...
void DataStruct::CppSign::sign_list_add(
...
int DataStruct::CppSign::sign_list_remove(SignList *list, int x, int y, int z, int face) {
    int result = 0;
...
int DataStruct::CppSign::sign_list_remove_all(SignList *list, int x, int y, int z) {
    int result = 0;
    for (int i = 0; i < list->size; i++) {
        Sign *e = list->data + i;
